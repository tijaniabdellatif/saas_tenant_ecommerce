...
export default function FooterBanner() {
  ...
  return (
    ...
    >
      <div className="mb-4 md:mb-0 text-neutral-600 text-base text-center lg:text-left">
      ...
      <div className="flex gap-4 text-sm lg:text-base">
        ...
        <Link href={route('conditions')}className="text-neutral-600 hover:text-[#D4AF37]">Terms of Service</Link>
        <Link href={'#'} className="text-neutral-600 hover:text-[#D4AF37]">Cookies</Link>
      </div>
    </motion.div>
  );
